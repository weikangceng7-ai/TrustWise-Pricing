...
const SUBSCRIPTION_TYPES = ["price", "inventory", "news", "all"] as const
  ...
  server.tool(
    ...
    async (
      ...
      try {
        ...
        const sub = (result.data as any).subscription || result.data
        return {
          content: [
  ...
  server.tool(
    ...
    async (
      ...
      try {
        ...
        const subs = (result.data as any).subscriptions || []
  ...
  server.tool(
    ...
    async (
      ...
      try {
        ...
        const alertsData = (result.data as any)?.data || result.data
