...
export function registerCommodityTools(server, config, client) {
    // ========== list_commodities ==========
    server.tool("list_commodities", "列出系统支持的所有大宗原料品种，包括硫磺、磷矿、钾肥、尿素，返回当前价格、趋势、波动性和风险等级", {}, async ({}, _extra) => {
        try {
    ...
    server.tool("get_commodity_analysis", "获取指定品种的详细分析，包括关键驱动因素、市场展望、品种间相关性和行业对比", {
