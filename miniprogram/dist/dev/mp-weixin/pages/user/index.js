...
const _sfc_main = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { user, goToSetting, showAbout, clearCache, ref: common_vendor.ref };
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    c: common_vendor.o(($event) => $setup.goToSetting("enterprise")),
    d: common_vendor.o(($event) => $setup.goToSetting("api")),
    e: common_vendor.o(($event) => $setup.goToSetting("notification")),
    f: common_vendor.o(($event) => $setup.goToSetting("data")),
    g: common_vendor.o($setup.showAbout),
    h: common_vendor.o($setup.clearCache)
  };
}
